...
class PublicRepositoriesOwnerModel {
  PublicRepositoriesOwnerModel({
    this.login,
    this.id,
    this.nodeId,
    this.avatarUrl,
  ...
  factory PublicRepositoriesOwnerModel.fromRawJson(String str) =>
      PublicRepositoriesOwnerModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PublicRepositoriesOwnerModel.fromJson(Map<String, dynamic> json) =>
      PublicRepositoriesOwnerModel(
